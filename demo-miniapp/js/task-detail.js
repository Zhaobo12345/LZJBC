const TaskDetailPage = (function() {
    ...
    let currentTaskStatus = TaskStatus.COMPLETED;
    ...
    function updateTaskStatus(status) {
        ...
        if (status === TaskStatus.CONFIGURING) {
            ...
            if (executorList) executorList.style.display = 'flex';
            if (executorItem) executorItem.style.display = 'flex';
            if (noExecutorView) noExecutorView.style.display = 'none';
            if (addExecutorBtn) addExecutorBtn.style.display = 'none';
            ...
            const executorList2 = document.getElementById('executorList');
            const executorItem2 = document.getElementById('executorItem');
            const noExecutorView2 = document.getElementById('noExecutorView');
            const addExecutorBtn2 = document.getElementById('addExecutorBtn');
            
            if (executorList2) executorList2.style.display = 'flex';
            if (executorItem2) executorItem2.style.display = 'flex';
            if (noExecutorView2) noExecutorView2.style.display = 'none';
            if (addExecutorBtn2) addExecutorBtn2.style.display = 'none';
